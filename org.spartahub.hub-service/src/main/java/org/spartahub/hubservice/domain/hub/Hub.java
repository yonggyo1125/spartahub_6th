...
/**
 * 0. 허브 관리는 마스터 관리자(MASTER), 허브 관리자(HUB_MANAGER)에 의해 이루어 지며
 ...
 *
 * 1. 허브는 전국 17개가 존재하여, 추가, 수정, 삭제가 가능해야 한다.
 * 2. 허브간 최적의 이동 경로를 산출하게 되므로 그 기반이 되는 주소, 위도, 경도는 필수
 * 3. 허브가 추가, 수정, 삭제가 되면 허브 경로 역시 재산출 되어야 한다(Route)
 */
